function initengahan(){
  ...
  function aktipesan4(){
    wallpaper.style="transform: scale(1.5);";kalimat.innerHTML=pesan4.innerHTML + nama + " :p";kalimat.style="transform:scale(1.2)";setTimeout(aktipesan5,1000);
  }
  ...
  afterComplete: function(){
    pesan5.innerHTML=vketik5 + " XD";setTimeout(aktipesan6,800);
  },}).go();
  }
